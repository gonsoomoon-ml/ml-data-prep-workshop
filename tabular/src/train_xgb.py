...
def load_dataset(path, sep, label_column):
    # Load dataset
...
if __name__ == '__main__':
    ...
    x_train, y_train = load_dataset(os.path.join(training_dir, 'train.csv'), ',', label_column)
    x_val, y_val     = load_dataset(os.path.join(validation_dir, 'validation.csv'), ',', label_column)
